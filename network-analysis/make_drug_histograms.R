...
dir <- "/Users/christopherwilliams/Desktop/stanford/Fall\ 2013/CS274/projects/network-analysis/"
sunetID             <- "ccwillia"
f.pairwise.tanimoto <- paste0(dir, "output/all_pairwise_tanimoto.csv")
f.all               <- paste0(dir, "output/all_tanimoto.png")
f.shared            <- paste0(dir, "output/shared_tanimoto.png")
f.notshared         <- paste0(dir, "output/notshared_tanimoto.png")
f.colored           <- paste0(dir, "output/colored_tanimoto.png")
