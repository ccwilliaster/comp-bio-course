...
def make_test_Items():
    P0 = Item([1,1,1], POS_CLASS)
    P1 = Item([1.1,1.2,1.1], POS_CLASS)
    P2 = Item([2,2,2], POS_CLASS)
    P3 = Item([3,3,3], POS_CLASS)
    N4 = Item([20,20,20], NEG_CLASS)
...
def test_classify_Items():
    ...
    assert d1["TP"] == d3["TP"] == 1
    assert d2["FN"] == 1
    assert d4["FP"] == d5["FP"] == d7["FP"] == d8["FP"] == d9["FP"] ==  1
    assert d6["TN"] == 1
